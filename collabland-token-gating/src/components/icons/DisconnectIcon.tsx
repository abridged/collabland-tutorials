...
const DisconnectIcon: React.ElementType<React.SVGProps<SVGSVGElement>> = ({ width = '800px', height = '800px' }) => (
  <svg width={width} height={height} viewBox="0 0 1024 1024" fill="#000000" xmlns="http://www.w3.org/2000/svg">
